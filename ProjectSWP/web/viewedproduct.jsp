<%-- 
    Document   : viewedproduct
    Created on : 31 Jul 2024, 22:50:16
    Author     : dumspicy
--%>
...
<html>
    ...
    <body>
        ...
        <c:if test="${empty viewedProduct}">
            <!--latest product when no product on viewed product list-->
            <div class="container main-container">
                <h1 class="text-dark">Viewed Product</h1>
                <p class="text-opacity-50 fs-4">0 items</p>
                <p class="text-opacity-50 fs-4">Go choose some product to view</p>
                <div class="row">
        ...
        <c:if test="${not empty viewedProduct }">
            <div class="container main-container">
                <h1 class="text-dark">Viewed Product</h1>
                <p id="wishlist-item-count" class="text-opacity-50 fs-4">${viewedProduct.size()} items</p>
                <div class="row">
                    <!-- Left Column -->
