    ...
    <body>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="p-3 p-lg-5 border bg-white">
                                    ...
                                    <div class="payment-method border p-3 mb-3">
                                        ...
                                        <div id="cod-disabled-week" class="text-danger" style="display:none;">You have been disabled from COD shipping for 1 week because of violating the rules.</div>
        ...
        <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            // Check if Ship COD should be disabled
            <c:if test="${sessionScope.cod_disabled_forever}">
                            document.getElementById('payment-cod').disabled = true;
                            document.getElementById('cod-disabled-forever').style.display = 'block';
            </c:if>

            <% if (codDisabledUntil != null && codDisabledUntil.isAfter(currentDate)) { %>
                            document.getElementById('payment-cod').disabled = true;
                            document.getElementById('cod-disabled-week').style.display = 'block';
            <% } %>
                        });
