...
public class OrderDAO extends DBContext {
    ...
    public List<OrderDetail> getOrderDetailByOrderID(int orderID) {
        List<OrderDetail> listorderdetail = new ArrayList<>();
        String sql = "SELECT od.Order_DetailID,od.Cart_DetailID,od.Order_DetailID,p.ProductID,p.Title,  p.SalePrice, p.Thumbnail,od.Quantities, p.SalePrice * od.Quantities AS price "
    ...
    public static void main(String[] args) {
        OrderDAO dao = new OrderDAO();
        List<Orders> order = dao.getAllOrders(1);
        for (Orders o : order) {
