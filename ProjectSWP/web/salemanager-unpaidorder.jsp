                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Unpaid Order</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                ...
                                <c:forEach var="o" items="${orders}" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${o.orderStatus == 'Unpaid'}">
                                                <a class="btn btn-cancel btn-sm text-white" href="changestatus?order_id=${o.orderID}&status=${o.orderStatusID}&value=6&page=UnpaidPage">Cancel</a>
                                            </c:if>
                                        </td>
                                    </tr>
                                </c:forEach>
