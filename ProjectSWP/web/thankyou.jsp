<%-- 
    Document   : thankyou
    Created on : May 10, 2024, 3:28:23 PM
    Author     : admin
--%>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
			...
			<div class="container">
				<a class="navbar-brand" href="homepage">Furni<span>.</span></a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center pt-5">
          ...
          <p><a href="product" class="btn btn-sm btn-outline-black">Back to shop</a></p>
        </div>
      </div>
    </div>
  </div>
