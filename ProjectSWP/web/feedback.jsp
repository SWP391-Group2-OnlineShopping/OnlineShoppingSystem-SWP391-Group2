                        ...
                        <div class="card-body">
                            <form id="feedbackForm" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="content" name="content" rows="5" maxlength="2000"></textarea>
                                    <small id="charCount" class="form-text text-muted">max 2000 characters</small>
                                </div>
                                <div class="mb-3">
